...
typedef enum
{
    ...
    //0X200对应的电机ID
    CAN_CHASSIS_3508_MOTOR_1=0x210,
    CAN_CHASSIS_3508_MOTOR_2=0x202,
    CAN_CHASSIS_3508_MOTOR_3=0x203,
    CAN_CHASSIS_3508_MOTOR_4=0x208,
    CAN_THRUST_ANGLE_2006=0x204,
    CAN_THRUST_MOVE_2006=0x201,
    ...
    CAN_2006_TRIGGER=0x206,
    CAN_6020_YAW=0x205,
    CAN_3508_DRIVE_RIGHT=0x207,
    CAN_3508_DRIVE_LEFT=0x208,
    CAN_2006_THRUST_ANGLE=0x202,
    CAN_2006_THRUST_MOVE=0x201
...
extern motor_measure_t motor_3508[2];
